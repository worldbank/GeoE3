...
from geoe3.core.osm_downloaders import OSMDownloadType
from geoe3.core.workflows.mappings import CYCLEWAY_CLASSIFICATION, HIGHWAY_CLASSIFICATION
from geoe3.utilities import log_message, setting
